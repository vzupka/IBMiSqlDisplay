...
echo jar cvfm  IBMiSqlDisplay.jar  manifestIBMiSqlDisplay.txt  -C build/classes  display/U_MainWindow_Parameters.class  -C build/classes  display -C build/classes locales
jar cvfm  IBMiSqlDisplay.jar  manifestIBMiSqlDisplay.txt  -C build/classes  display/U_MainWindow_Parameters.class  -C build/classes  display -C build/classes locales
